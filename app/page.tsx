    ...
    <main>
      ...
      <section className="hero">
        ...
        <div className="hero-inner">
          <div className="eyebrow"><i /> NEW BATCH · PRACTICAL BUSINESS LEARNING</div>
          <h1>Build the business<br /><em>mindset to move.</em></h1>
          <p className="hero-copy">A practical learning experience for aspiring entrepreneurs, early-stage founders and professionals who want to understand how businesses actually work — and learn by doing.</p>
          <div className="hero-actions">
            <button className="primary-btn" onClick={startQuiz}>Find My Best Program <span>→</span></button>
            <a className="text-btn" href="#why">See how PerpeX works <span>↓</span></a>
          </div>
          <div className="hero-trust">
            <span>Designed around your stage</span><b>·</b>
            <span>Practical learning</span><b>·</b>
            <span>Mentor-led experience</span>
          </div>
        </div>
        <div className="hero-card">
          <div className="card-top"><span>01 / 06</span><span>Business Fit Assessment</span></div>
          <div className="mini-question">Which path fits <strong>you?</strong></div>
          <div className="mini-options"><span>GrowthX</span><span>Online + Hybrid</span><span>Cohort B-School</span></div>
          <div className="mini-line"><span /><span /></div>
          <div className="mini-caption">Answer a few questions. Get a recommendation built around your goals.</div>
        </div>
      </section>
